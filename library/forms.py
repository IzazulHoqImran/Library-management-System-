...
class IssueBookForm(forms.Form):
    ...
    name2 = forms.ModelChoiceField(queryset=models.Student.objects.all(), empty_label="Name [department] [semester] [student id]", to_field_name="user", label="Student Details")
